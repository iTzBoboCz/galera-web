<template>
  <v-expansion-panel>
    ...
    <v-expansion-panel-text>
      <!--
        https://github.com/photoprism/photoprism/blob/develop/frontend/src/pages/albums.vue
        https://github.com/photoprism/photoprism/blob/develop/frontend/src/dialog/share.vue
      -->
